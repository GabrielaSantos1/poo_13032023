...
int main() {
    ...
    cout << "Digite a base do triângulo e dê ENTER: ";
    ...
    cout << "Digite a altura do triângulo e dê ENTER: ";
    // ajusta o valor da altura para o valor digitado pelo user
    cin >> altura;
    
    
    // o valor da área é igual ao valor dado pelo user da base * altura depois dividido por 2, está entre parenteses para que a multiplicação seja feita antes da divisão
    area = (base * altura) / 2;
    
    // printa para o user que a área do triangulo é o valor da área e finaliza a linha de interação.
